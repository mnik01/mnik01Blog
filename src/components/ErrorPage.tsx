  ...
  return (
    <>
      ...
      >
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="z-50 w-32 h-32 text-white">
        ...
        <Link href='/'>
          <a className='z-50 text-white text-xl font-medium'>Лучше вернуться на <b className='text-blue-200 underline'>главную</b>...</a>
        </Link>
      </main>
    </>
  )
