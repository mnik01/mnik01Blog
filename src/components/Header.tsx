...
export const Header: FC<{ extendClasses?: string }> = ({ extendClasses }) => {
  ...
  return (
    <header className={`${extendClasses} ${shouldExpandMenu ? 'shadow-xl dark:drop-shadow-2xl dark:shadow-2xl' : ''} text-p z-[200] w-full fixed top-0 bg-white dark:bg-dark dark:text-light text-sm font-inter`}>
